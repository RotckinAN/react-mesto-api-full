...
function EditAvatarPopup({ isOpen, onClose, onUpdateAvatar, isLoading }) {
   ...
   return (
      <PopupWithForm name='avatarUpdate' title='Обновить аватар'
                     additionalClassName='popup__content-title_type_avatarCreate' buttonText={buttonText}
                     isOpen={isOpen} onClose={onClose} onSubmit={handleSubmit}
                     isFormValid={formValid}> {/* попап обновления аватара */}
         <label htmlFor="inputPictureAvatar">
            <input onChange={avatar.handleChange} ref={inputRef} type="url" className={avatarInputClassName}
                   name="avatar" autoComplete="off"
